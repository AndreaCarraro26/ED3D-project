...
cv::Mat reproject(osg::ref_ptr<osg::Node> model, Configuration params) {
	...
	// Allocation of intersection points vectors
	...
	osg::Vec3 source2(laser2X, laser2Y, laser2Z);						
